                ...
                <form method="POST" action="../scripts/register.php">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="last_name" id="last_name" value="<?php echo htmlspecialchars($data['last_name'] ?? 'Иванов'); ?>" <?php echo !empty($errors['last_name']) ? 'class="is-invalid"' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="first_name" id="first_name" value="<?php echo htmlspecialchars($data['first_name'] ?? 'Иван'); ?>" <?php echo !empty($errors['first_name']) ? 'class="is-invalid"' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="middle_name" id="middle_name" value="<?php echo htmlspecialchars($data['middle_name'] ?? 'Иванович'); ?>" <?php echo !empty($errors['middle_name']) ? 'class="is-invalid"' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="phone" id="phone" placeholder="+7(XXX)-XXX-XX-XX" value="<?php echo htmlspecialchars($data['phone'] ?? '+7(999)-123-45-67'); ?>" <?php echo (!empty($errors['phone']) || !empty($errors['unique_phone'])) ? 'class="is-invalid"' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" id="email" value="<?php echo htmlspecialchars($data['email'] ?? 'test@example.com'); ?>" <?php echo (!empty($errors['email']) || !empty($errors['unique_email'])) ? 'class="is-invalid"' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="login" id="login" value="<?php echo htmlspecialchars($data['login'] ?? 'litvinov'); ?>" <?php echo (!empty($errors['login']) || !empty($errors['unique_login'])) ? 'class="is-invalid"' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password" id="password" value="<?php echo htmlspecialchars($data['password'] ?? 'password123'); ?>" <?php echo !empty($errors['password']) ? 'class="is-invalid"' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password_confirm" id="password_confirm" value="<?php echo htmlspecialchars($data['password_confirm'] ?? 'password123'); ?>" <?php echo !empty($errors['password_confirm']) ? 'class="is-invalid"' : ''; ?>>
                        </div>
